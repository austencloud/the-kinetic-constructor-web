...
test('debug Generate tab', async ({ page }) => {
	...
	await page.waitForSelector('.main-layout-wrapper', { state: 'visible', timeout: 30000 });
	...
	await page.screenshot({ path: 'test-results/generate-tab-debug.png', fullPage: true });
