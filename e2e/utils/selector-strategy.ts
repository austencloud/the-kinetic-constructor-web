...
export const selectors = {
	...
	app: {
		...
		fullscreenToggle: '[data-test="fullscreen-toggle"], button.fullscreen-toggle'
	},
	...
	generateTab: {
		...
		generateButton: '[data-test="generate-button"], button:has-text("Generate")',
		...
		turnIntensityInput: '[data-test="turn-intensity-input"], input[name="turnIntensity"]',
		propContinuitySelect: '[data-test="prop-continuity-select"], select[name="propContinuity"]',
	...
	writeTab: {
		...
		eraseActButton: '[data-test="erase-act-button"], button:has-text("Erase Act")',
