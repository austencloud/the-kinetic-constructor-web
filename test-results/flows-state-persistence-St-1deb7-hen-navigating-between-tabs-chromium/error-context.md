...
- Name: State Persistence >> should preserve tab state when navigating between tabs
- Location: C:\the-kinetic-constructor-web\e2e\flows\state-persistence.spec.ts:26:2
