...
const OFFLINE_FALLBACKS = {
  ...
  api: { error: 'offline', message: 'This feature requires an internet connection' }
}
...
async function storeOfflineAction(action) {
  try {
    ...
    const updated = [...existing, { ...action, id: Date.now(), timestamp: new Date() }]
