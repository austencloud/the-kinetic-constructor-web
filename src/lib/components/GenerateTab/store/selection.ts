...
export const selectedBeats = derived(selectionStore, ($selection) => $selection.selectedBeats);

export const selectionMode = derived(selectionStore, ($selection) => $selection.selectionMode);
