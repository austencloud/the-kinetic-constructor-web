...
<script lang="ts">
  ...
  import { settingsStore, numBeats, turnIntensity, propContinuity, capType, level } from '../store/settings';
  ...
  function handleGenerate() {
    if (useNewStateManagement) {
      ...
      sequenceActions.generate(settings, $settingsStore.generatorType);
    } else {
