...
// Active layout rule state using Svelte 5 runes
let activeLayoutRuleState = $state<any>(null);

// Getter function for accessing the active layout rule
export function activeLayoutRule(): any {
	return activeLayoutRuleState;
}
