...
<script lang="ts">
	...
	import { SimpleBackgroundSystem, type BackgroundType, type QualityLevel } from './SimpleBackgroundSystem.svelte.ts';
	...
	let backgroundSystem: SimpleBackgroundSystem | null = null;
	...
	onMount(() => {
		...
		backgroundSystem = new SimpleBackgroundSystem(bgType, qualityLevel);
