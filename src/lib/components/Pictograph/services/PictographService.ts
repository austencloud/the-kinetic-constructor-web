// src/lib/components/Pictograph/services/PictographService.ts

import type { PictographData } from '$lib/types/PictographData';
import type { PropData } from '$lib/components/objects/Prop/PropData';
import type { ArrowData } from '$lib/components/objects/Arrow/ArrowData';
import type { GridData } from '$lib/components/objects/Grid/GridData';
import { Motion } from '../../../components/objects/Motion/Motion';
import type { MotionData } from '../../../components/objects/Motion/MotionData';
...
export class PictographService {
   ...
   */
  private calculateArrowLocation(motion: Motion, defaultLoc: Loc): Loc {
  ...
  positionArrows(redArrow: ArrowData | null, blueArrow: ArrowData | null, grid: GridData): void {
    ...
    if (redArrow || blueArrow) {
      try {
        // Use the config object pattern for ArrowPlacementManager
