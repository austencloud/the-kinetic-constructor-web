<!-- src/lib/components/SequenceWorkbench/BeatFrame/BeatFrameComposableWithEvents.svelte -->
<!-- Alternative implementation that properly communicates scrollable state via events -->
<script lang="ts">
