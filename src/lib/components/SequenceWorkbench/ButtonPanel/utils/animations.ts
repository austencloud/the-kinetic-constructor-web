 ...
 */
export function getAnimationName(layout: LayoutOrientation, isEntering: boolean): string {
	if (layout === 'vertical') {
 ...
 */
export function getToggleIndicatorIcon(layout: LayoutOrientation, isVisible: boolean): string {
	if (layout === 'vertical') {
