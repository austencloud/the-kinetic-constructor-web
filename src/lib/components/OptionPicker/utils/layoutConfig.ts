...
export const LAYOUT_RULES: LayoutRule[] = [
    ...
    {
        description: 'Many items (17+) on mobile, square = 4 columns', // Merged widish into square
        columns: 4,
    ...
    {
        description: 'Few/Medium items (3-16) on desktop, square = 4 columns', // Merged widish into square
        columns: 4,
    ...
    {
        description: 'Many items (17+) on desktop, square = 6 columns', // Merged widish into square
        columns: 6,
