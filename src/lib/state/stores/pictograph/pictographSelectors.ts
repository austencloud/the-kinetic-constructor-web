...
export const pictographComponents = createDerived(() => pictographContainer.state.components);

export const pictographStateHistory = createDerived(() => pictographContainer.state.stateHistory);
...
export const redPropData = createDerived(() => pictographContainer.state.data?.redPropData || null);
...
export const gridMode = createDerived(() => pictographContainer.state.data?.gridMode || 'diamond');
