...
import type { BackgroundType, QualityLevel, PerformanceMetrics } from '$lib/components/Backgrounds/types/types';
...
// Create the store
export const backgroundStore = createStore<BackgroundStoreState, {
