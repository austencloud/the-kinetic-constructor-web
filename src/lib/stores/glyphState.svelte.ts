...
// Create asset cache state using Svelte 5 runes
let assetCacheState = $state<AssetCache>({
...
// Export getter and setter functions for the asset cache
export const assetCache = {
	get state() {
		return assetCacheState;
	},
	update: (updater: (cache: AssetCache) => AssetCache) => {
		assetCacheState = updater(assetCacheState);
	}
};
